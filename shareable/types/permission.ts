...
/**
 * Used to define information about the dependency of a permission to other groups.
 */
export interface ExternalPermissionDependencyInfo<T extends GeneralObject<number>, U> {
	group: PermissionGroup<T, U>,
	permissionDependencies: U[]
}
